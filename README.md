...
Once the `conda-forge` channel has been enabled, `openfe` can be installed with:

```
conda install openfe
```

It is possible to list all of the versions of `openfe` available on your platform with:
